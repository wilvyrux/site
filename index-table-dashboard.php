                ...
                <div class="main-content">  <!-- main contents -->
                        ...
                        <!-- you can insert your code here  -->
                                ...
                                <div class="container">
                                    ...
                                    <div class="col-md-6">
                                        <!-- elements table small structure -->
                                        <?php include 'elements/table-small-structure.php'; ?>
                                        <!-- end elements table small structure -->
                                    </div>

                                    <div class="col-md-3">
                                        <div class="table-primary text-center">
                                            <h4>Unque template count</h4>
                                    ...
                                    <div class="col-md-12">
                                          <!-- elements table structure -->
                                         <?php include '/elements/table-sctructure.php'; ?>
                                          <!-- end elements table structure -->
                                    </div>
