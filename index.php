...
<html lang="en">
  <head>
    ...
    <title>Wilvyrux Resources</title>
        ...
        <section class="main-wrapper">
                ...
                <div class="main-content">  <!-- main contents -->
                        ...
                        <!-- you can insert your code here  -->
                                ...
                                <div class="container">
                                        <div class="col-md-12">
                                            <!-- <h3> buttons bootstrap </h3>

                                            <button type="button" class="btn btn-green btn-cancel">Green Cancel</button>
                                            <button type="button" class="btn btn-green">Green</button>
                                            <button type="button" class="btn btn-blue"> Blue </button>
                                            <button type="button" class="btn btn-blue btn-cancel"> Blue cancel </button>
                                            <button type="button" class="btn btn-blue btn-cancel btn-disable">disable</button>
                                            <button type="button" class="btn btn-gray">Gray</button>
                                            <button type="button" class="btn btn-gray btn-cancel">Gray Cancel</button> -->
                                            ...
                                            <h2>Left Sidebar Option & Content</h2>
                                            <p>
